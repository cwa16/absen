...
use App\Http\Controllers\ChangeAbsenController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Route::get('/', [AdminController::class, 'new_dash'])->name('dashboard');
    Route::get('/', [AdminController::class, 'new_dash'])->name('dashboard');
    ...
    Route::get('/attendance-input-ubah', [AdminController::class, 'attendance_edit'])->name('attendance-input-ubah');
    Route::post('/attendance-input-ubah-new', [AdminController::class, 'attendance_edit_new'])->name('attendance-input-ubah-new');
    Route::post('update-absen-edit', [AdminController::class, 'update_attendance_edit'])->name('update-absen-edit');
    ...
    Route::post('/update-active-check', [AdminController::class, 'update_active'])->name('update-active');
    ...
    Route::get('/summary-per-dept-filter-pdf', [SummaryPerDeptRegController::class, 'filter_print'])->name('summary-per-dept-filter-pdf');
    Route::post('/summary-per-dept-pdf', [SummaryPerDeptRegController::class, 'export_pdf'])->name('summary-per-dept-pdf');
    ...
    Route::get('/summary-kategori-new', [SummaryPerKategoriController::class, 'index_new'])->name('summary-kategori-new');
    Route::post('/get-data-kategori', [SummaryPerKategoriController::class, 'getDataPerkategori'])->name('summary-kategori-get');

    // Summary kehadiran per dept
    Route::get('/summary-per-dept-filter-dept', [SummaryPerDeptRegController::class, 'filter_dept'])->name('summary-per-dept-filter-dept');
    Route::post('/summary-per-dept-filter-mandor', [SummaryPerDeptRegController::class, 'filter_mandor'])->name('summary-per-dept-filter-mandor');
    Route::post('/summary-per-dept-mandor-per-emp', [SummaryPerDeptRegController::class, 'mandor_per_emp'])->name('summary-per-dept-mandor-per-emp');
    Route::post('/summary-per-dept-mandor-per-emp-for-dash', [SummaryPerDeptRegController::class, 'mandor_per_emp_dash'])->name('summary-per-dept-mandor-per-emp-for-dash');
    Route::post('/summary-per-dept-filter-new', [SummaryPerDeptRegController::class, 'result'])->name('summary-per-dept-filter-new');
    Route::get('/data-mandor', [SummaryPerDeptRegController::class, 'getMandor'])->name('data-mandor');
    ...
    Route::post('update-emp', [AdminController::class, 'update_emp'])->name('update-emp');
    Route::post('delete-emp', [AdminController::class, 'delete_emp'])->name('delete-emp');
    Route::get('/delete-photo/{nik}', [AdminController::class, 'delete_photo'])->name('delete-photo');
    ...
    Route::post('/print-attendance', [TestingAbsenController::class, 'print_filter'])->name('print-attendance-filter');
    ...
    Route::post('/month-filter', [TestingAbsenController::class, 'view_month_filter'])->name('view-summary-emp-filter-month');
    Route::post('/testing-update', [TestingAbsenController::class, 'update'])->name('testing-update');
    Route::post('/testing-update-shift-3', [TestingAbsenController::class, 'update_shift_3'])->name('testing-update-shift-3');
    // Route::post('/update-new', [TestingAbsenController::class, 'update_shift_new'])->name('update-new');
    Route::post('/update-new', [ChangeAbsenController::class, 'update_shift_new'])->name('update-new');
    // Route::post('/update-new', [TestingAbsenController::class, 'update_att_data'])->name('update-new');
    Route::post('/update-desc', [TestingAbsenController::class, 'update_desc_att_data'])->name('update-desc');
    Route::post('/export-sequel', [TestingAbsenController::class, 'export_sequel'])->name('export-sequel');
    Route::post('/archive-attlog', [TestingAbsenController::class, 'att_log_archive'])->name('att-log-archive');
    Route::post('/archive-absenregs', [TestingAbsenController::class, 'absen_regs_archive'])->name('absen-regs-archive');
    ...
    Route::get('/shift-setting', [MasterShiftController::class, 'shift_setting'])->name('shift-setting');
    Route::get('/shift-setting-detail/{nik}', [MasterShiftController::class, 'shift_setting_shift'])->name('shift-setting-detail');
    Route::get('/shift-setting-edit/{nik}', [MasterShiftController::class, 'shift_setting_edit'])->name('shift-setting-edit');
    Route::post('/shift-setting-update/{id}', [MasterShiftController::class, 'shift_setting_update'])->name('shift-setting-update');
    Route::post('/shift-setting-add', [MasterShiftController::class, 'shift_setting_store'])->name('shift-setting-add');
    ...
    Route::post('/del-att-data', [TestingAbsenController::class, 'delete_att_data'])->name('del-att-data');


    // EmployeeReport
    Route::get('/employee-list-report', [EmployeeReportController::class, 'index'])->name('employee-list-report');
    Route::get('/employee-list-report-excel', [EmployeeReportController::class, 'index_excel'])->name('employee-list-report-excel');
    Route::post('print-list-report', [EmployeeReportController::class, 'print'])->name('print-list-report');
    Route::post('excel', [EmployeeReportController::class, 'excel'])->name('excel-user');
    Route::get('print-career/{nik}', [EmployeeReportController::class, 'print_career'])->name('print-career-report');
    Route::get('print-general/{nik}', [EmployeeReportController::class, 'print_general'])->name('print-general-report');

    // Enroll Data
    Route::get('/enroll-data', [EnrollController::class, 'index'])->name('enroll-data');
    Route::get('/enroll-data-detail', [EnrollController::class, 'index_detail'])->name('enroll-data-detail');
    Route::get('/enroll-data-contract', [EnrollController::class, 'index_contract'])->name('enroll-data-contract');

    Route::post('/send-mail', [TestingAbsenController::class, 'test_mail'])->name('test-mail');
    Route::get('/index-mail-batch', [TestingAbsenController::class, 'index_mail_batch'])->name('index-mail-batch');
    Route::post('/filter-mail-batch', [TestingAbsenController::class, 'filter_mail_batch'])->name('filter-mail-batch');
    Route::post('/send-mail-batch', [TestingAbsenController::class, 'send_mail_batch_new'])->name('send-mail-batch');
    Route::post('/send-mail-preview', [TestingAbsenController::class, 'preview_send'])->name('send-mail-preview');

    Route::get('/work-hour', [WorkHourController::class, 'index'])->name('work-hour');
    Route::post('work-hour', [WorkHourController::class, 'store'])->name('store-work-hour');
    Route::get('/delete-work-hour/{id}', [WorkHourController::class, 'delete'])->name('delete-work-hour');
    Route::get('/work-hour/{id}', [WorkHourController::class, 'edit_hour'])->name('edit-work-hour');

    Route::get('/set-work-hour', [WorkHourController::class, 'index_set'])->name('set-work-hour');
    Route::post('/set-work-hour-select-dept', [WorkHourController::class, 'select_dept'])->name('set-work-hour-select-dept');
    Route::post('set-work-hour-store', [WorkHourController::class, 'set_workhour'])->name('set-work-hour-store');

    Route::get('/master-work-hour', [WorkHourController::class, 'index_master'])->name('master-work-hour');
    Route::post('/store-master-work-hour', [WorkHourController::class, 'store_master'])->name('store-master-work-hour');
    Route::get('/delete-work-hour-master/{id}', [WorkHourController::class, 'delete_master'])->name('delete-work-hour-master');

    Route::get('/workhour-setting', [WorkHourController::class, 'index_workhour_setting'])->name('workhour-setting');
    Route::post('/store-work-hour-setting', [WorkHourController::class, 'store_workhour_setting'])->name('store-work-hour-setting');

    Route::get('/index-att-table', [TestingAbsenController::class, 'table_att_data'])->name('table_att_data');

    Route::get('/index-jabatan', [MasterJabatanController::class, 'index'])->name('master-jabatan');
    Route::post('store-jabatan', [MasterJabatanController::class, 'store'])->name('store-jabatan');
    Route::get('/delete-jabatan/{id}', [MasterJabatanController::class, 'delete'])->name('delete-jabatan');
});
