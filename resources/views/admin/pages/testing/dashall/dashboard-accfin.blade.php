...
<body class="g-sidenav-show bg-gray-200">
                        ...
                        <div class="card z-index-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-sm "> (<span
                                        ...
                                        %</span>) total kehadiran Acc & Fin</p>
                        ...
                        <div class="card z-index-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-sm "> (<span
                                        ...
                                        %</span>) total kehadiran Regular Acc & Fin</p>
                                <hr class="dark horizontal">
                                <div class="d-flex ">
                                    <i class="material-icons text-sm my-auto me-1">schedule</i>
                                    <p class="mb-0 text-sm"> last updated at ({{ $latest }}) </p>
                        ...
                        <div class="card z-index-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-sm "> (<span
                                        ...
                                        %</span>) total kehadiran Regular Sub Divisi Acc & Fin</p>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg mt-4">
                        <div class="card z-index-2">
                            ...
                            <div class="card-body">
                                <h6 class="mb-0 ">Todate Kehadiran Harian Sub Divisi Acc & Fin </h6>
                                <p class="text-sm "> (<span
                                        class="font-weight-bolder">{{ number_format($per_tot_reg_h, 1) }}
                                        %</span>) total Todate Kehadiran Regular Sub Divisi Acc & Fin</p>
                                <hr class="dark horizontal">
                                <div class="d-flex ">
                                    <i class="material-icons text-sm my-auto me-1">schedule</i>
                                    <p class="mb-0 text-sm"> last updated at ({{ $latest }}) </p>
    ...
    <script>
        ...
        var myChart1 = new Chart(ctx1, {
            ...
            type: 'bar',
            data: {
                labels: ["Acc & Fin", "I/B", "I/C", "II/D", "II/E", "II/F"],
                datasets: [{
                        label: 'Hadir',
                        data: [
                            {{ $reg_h }}
        ...
        var myChart1 = new Chart(ctx1, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Kehadiran Regular per {{ $date }} Sub Divisi Acc & Fin'
                    },
                }
            }
        ...
        var myChart1 = new Chart(ctx1, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Todate Kehadiran Regular per {{ $date }} Sub Divisi Acc & Fin'
                    },
                }
            }
