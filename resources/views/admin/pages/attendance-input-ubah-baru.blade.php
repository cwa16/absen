                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Attendance Table - Ubah</h6>
                            </div>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('update-absen-edit') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <table class="table table-striped table-bordered table-responsive"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" colspan="2" class="align-middle text-center">
                                                    Keterangan</th>
                                            </tr>
                                            <tr>
                                                ...
                                                <tr class="tr-clone-0" id="uploadrow_0">
                                                    <td>
                                                        ...
                                                        <select name="user_id[]" id="name"
                                                            ...
                                                            <option value="{{ $item->nik }}">{{ $item->name }}
                                                            </option>
                                                    ...
                                                    <td>
                                                        <input type="date" name="date_select[]" id=""
                                                    ...
                                                    @if ($item->start_work == null)
                                                        <td>
                                                            <input type="time" name="start_work[]" id="start_work_0" class="form-control form-control-sm start_work_0">
                                                        </td>
                                                    @else
                                                        <td>
                                                            <input type="time" name="start_work[]" id="start_work_0"
                                                                class="form-control form-control-sm start_work_0" value="{{ \Carbon\Carbon::parse($item->start_work)->format('H:i') }}">
                                                        </td>
                                                    @endif
                                                    ...
                                                    <td>
                                                        <input type="text" name="start_work_info[]"
                                                            ...
                                                            id="start_work_info_0" value="{{ $item->start_work_info }}">
                                                    </td>
                                                    ...
                                                    @if ($item->end_work == null)
                                                        <td>
                                                            <input type="time" name="end_work[]" id="" class="form-control form-control-sm">
                                                        </td>
                                                    @else
                                                        <td>
                                                            <input type="time" name="end_work[]" id=""
                                                                class="form-control form-control-sm" value="{{ \Carbon\Carbon::parse($item->end_work)->format('H:i') }}">
                                                        </td>
                                                    @endif

                                                    <td>
                                                        <input type="text" name="end_work_info[]"
                                                            class="form-control form-control-sm" value="{{ $item->end_work_info }}">
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <select name="desc[]" id="desc1"
                                                            ...
                                                            <option value="{{ $item->desc }}" selected>{{ $item->desc }}</option>
                                                            <option value="H">Hadir (H)</option>
                                                            <option value="D">Dinas (D)</option>
                                                            <option value="M">Mangkir (M)</option>
                                                            <option value="MX">Mangkir Hari Libur (MX)</option>
                                                    ...
                                                    <td>
                                                        <div class="info-area" id="info-area">
                                                            <input type="text" name="info[]"
                                                                class="form-control form-control-sm info" value="{{ $item->info }}">
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
    ...
    <script>
        ...
        $('#table-data').on('change', '.cek', function() {
            ...
            if (row.find('.cek').val() == 'S' || row.find('.cek').val() == 'SX') {
                ...
                row.find('.info span.select2').remove();
                ...
                return false;
            } else if (row.find('.cek').val() == 'I' || row.find('.cek').val() == 'IX') {
                $.each(ixlist, function(key, value) {
                    options = options + '<option value="' + value.name + '">' +
                        value
                        .name +
                        '</option>'
