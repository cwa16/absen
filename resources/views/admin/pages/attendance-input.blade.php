                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            ...
                            <!-- end bootstrap model -->
                            <a href="{{ route('input-manual') }}" class="btn btn-primary btn-sm"> Tambah Baru</a>
                            <a href="{{ route('attendance-input-ubah') }}" class="btn btn-primary btn-sm"> Ubah Data</a>
                                    ...
                                    <div class="table-responsive p-0">
                                        <table class="table table-striped table-bordered align-items-center mb-0"
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-center text-center">Datang</th>
                                            ...
                                            <tbody>
                                                @forelse ($data as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->start_work_info }}</td>
                                                        <td>{{ $item->start_work_info_url }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($item->end_work)->format('H:i:s') }}</td>
                                                        <td>{{ $item->end_work_info }}</td>
                                                        <td>{{ $item->end_work_info_url }}</td>
                                                        <td>{{ $item->desc }}</td>
                                                    </tr>
                                                @empty
                                                    <tr>
