...
<body class="g-sidenav-show bg-gray-200">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Employee List Report</h6>
                            </div>
                        </div>

                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('excel-user') }}" method="post" target="_blank">
                                    @csrf
                                    <div class="row">
                                        <div class="col">
                                            <label for="">Filter</label>
                                            <select name="att[]" id="att" class="form-select" multiple aria-label="multiple select example">
                                        ...
                                        <button class="btn btn-success btn-sm mt-4">Excel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script src="{{ url('js/jquery.multi-select.min.js') }}"></script>
    <script>
        $('#att').multiSelect();
    </script>
    <script>
