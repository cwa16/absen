        ...
        <table class="table-1">
            <thead>
                <tr class="td-2">
                    ...
                    <th rowspan="2" class="td-2 black-bg" style="width: 150px;">Employee Name</th>
                    <th rowspan="2" class="td-2 black-bg" style="width: 25px;">Sex</th>
                    <th rowspan="2" class="td-2 black-bg" style="width: 35px;">Grade</th>
                    <th rowspan="2" class="td-2 black-bg">Departement</th>
            ...
            <tbody>
                @foreach ($resign as $date_out => $item)
                <tr>
                    <td colspan="10"></td>
                </tr>
                    <tr>
                        <td><b><u>{{ \Carbon\Carbon::parse($item->date_out)->format('F') }}</u></b></td>
                    </tr>
                    {{-- Fetch and display individual employee details for the current department --}}
                    @foreach ($resign as $employee)
                        @if ($employee->date_out == $item->date_out)
                           <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="td-2">Total {{ \Carbon\Carbon::parse($item->date_out)->format('F') }}</td>
                        <td class="td-2">Person</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
