                    ...
                    <div class="card my-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <form action="{{ route('view-summary-emp-filter-reg') }}" method="POST">
                                        @csrf
                                        <div class="col">
                                            <label for="">
                                                <h3>Periode:
                                    ...
                                    <table class="table table-bordered table-sm table-detail" id="myTablex">
                                            ...
                                            @foreach ($emp1 as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ Carbon\Carbon::parse($emp->start_work_user)->format('H:i:s') }}
                                                        -
                                                        {{ Carbon\Carbon::parse($emp->end_work_user)->format('H:i:s') }}
                                                    </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>{{ $emp->absen_reg->where('desc', 'A')->count() }}</td>
                                                ...
                                                <td>{{ $emp->absen_reg->where('desc', 'TA')->count() }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
