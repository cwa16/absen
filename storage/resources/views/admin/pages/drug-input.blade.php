...
<body class="g-sidenav-show bg-gray-200">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Input Pemeriksaan Narkoba</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card">
    ...
    <script>
        $('#table-data').on('click', '.tr_clone_add', function() {
            ...
            $clone.find('.select-emp').removeClass('select2-hidden-accessible');
            $clone.find('.select-emp').removeAttr('data-select2-id');
            $tr.after($clone);
