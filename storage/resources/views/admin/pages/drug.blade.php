                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Master Drug Test</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <form action="{{ route('store-drug') }}" method="post">
                                            @csrf
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <a href="{{ route('add-drug',$item->id) }}" class="btn btn-primary">Add</a>
                                                            </div>
                                                        </td> 
                                                    </tr>
                                                @empty
