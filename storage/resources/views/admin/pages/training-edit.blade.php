                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Data Training Input - Edit</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('update-training') }}" method="post">
                                        @csrf
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <input type="hidden" name="id_data"
                                                        value="{{ $training->id_data }}">
                                                    <input type="text" name="no" id="id_training"
                                                        class="form-control form-control-sm" value="{{ $training->id_data }}"
                                                        readonly>
                                                </td>
                                                <td colspan="3">
                                                    <select name="kind" id="" class="form-control" required>
                                                        <option value="{{ $training->kind }}">{{ $training->kind }}
                                                        </option>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <input type="text" name="topic" id=""
                                                        ...
                                                        placeholder="Masukan Topik Training"
                                                ...
                                                <td colspan="2">
                                                    <select name="trainer" id=""
                                                        ...
                                                        <option value="{{ $training->user->nik }}" selected>
                                                            {{ $training->user->name }}
                                                        </option>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="date" name="date_from" id=""
                                                        class="form-control form-control-sm"
                                                        value="{{ $training->from_date }}" required>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_to" id=""
                                                        class="form-control form-control-sm"
                                                        value="{{ $training->to_date }}" required>
                                                </td>
                                                <td>
                                                    <input type="text" name="place" id=""
                                                        class="form-control form-control-sm"
                                                        placeholder="Masukan Tempat Training"
                                                        value="{{ $training->place }}" required>
                                                </td>
                                                <td colspan="2">
                                                    <input type="text" name="category" id=""
                                                        class="form-control form-control-sm"
                                                        placeholder="Masukan Kategori Training"
                                                        value="{{ $training->category }}" required>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <textarea name="summary" cols="30" rows="10" style="width: -webkit-fill-available;"
                                                        placeholder="Isi dengan Summary Training">{{ $training->summary }}</textarea>
                                                </td>
                                                <td colspan="2">
                                                    <textarea name="comment" id="" cols="30" rows="10" style="width: -webkit-fill-available;"
                                                        placeholder="Isi dengan Komentar Trainer">{{ $training->comment }}</textarea>
                                                </td>
                                            </tr>
                                                ...
                                                <tr class="tr_clone">
                                                    ...
                                                    <td>
                                                        <input type="text" name="" id="dept"
                                                            value="{{ $item->user->dept }}" class="form-control"
                                                            readonly>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="input-group">
                                                            ...
                                                            <a id="add-btn"
                                                                class="btn btn-warning btn-sm tr_clone_removed" href="{{ route('delete-training-item',[$item->id_training,$item->nik]) }}">-</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
