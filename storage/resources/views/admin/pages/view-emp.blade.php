                                      ...
                                      <div class="card-body">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <img src="{{  url('image/'.$emp->image_url)  }}" alt="" style="width: 272px;">
                                            </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="card">
                                      <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                          ...
                                          <tr>
                                            <th>Lokasi Absen</th>
                                            <td colspan="2">{{ $emp->loc }}</td>
                                            <td>2. {{ $emp->anak_2 }}</td>
                                          </tr>
                                          <tr>
                                            <th>Sistem Absen</th>
                                            <td colspan="2">{{ $emp->sistem_absensi }}</td>
                                            <td>3. {{ $emp->anak_3 }}</td>
                                          </tr>
                                        </table>
                                      </div>
                                    ...
                                    <div class="card mt-3">
                                      <div class="body">
                                        <table class="table table-bordered table-striped table-responsive table-hover">
                                          ...
                                          <tbody>
                                            <tr>
                                              <td class="text-center">{{ $emp->start_work_user }}</td>
