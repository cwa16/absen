                                        ...
                                        <table class="table table-striped table-hover table-sm" id="myTablex">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="align-middle" rowspan="2">Total <br>Jam Kerja <br>Ori</th>
                                            ...
                                            <tbody style="font-size: 12px;">
                                                @foreach ($emp1 as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->thour }} Jam, {{ $item->tmin }} Menit</td>
                                                        <td>{{ $shift_sum ?? 0 }}</td>
                                                        @php
                                                            // $rest = $emp1->count;
                                                            $late_jam = $item->late;
                                                        ...
                                                        <td>{{ $item->othour }} Jam, {{ $item->otmin }} Menit</td>
                                                        <td>{{ $item->h }}</td>
                                                        <td>{{ $item->l }}</td>
                                                        ...
                                                        <td>{{ $item->latehour }} Jam, {{ $item->latemin }} Menit</td>
                                                        <td>{{ $item->ta }}</td>
                                                        <td>{{ $item->d }}</td>
                                                        <td>{{ $item->m }}</td>
                                                        <td>{{ $item->mx }}</td>
