...
<body class="g-sidenav-show bg-gray-200">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <!-- boostrap add and edit book model -->
                        <div class="modal fade modal-att-start" id="ajax-book-model-att-start" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-scrollable">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h4 class="modal-title" id="ajaxBookModelAtt">Start Work Photo Information</h4>
                                  </div>
                                  <div class="modal-body">
                                          <div class="form-group">
                                            <div class="col-sm-12">
                                                <img class="form-control" src="" alt="" id="img-atts-start">
                                            </div>
                                        </div>
                                  </div>
                                  <div class="modal-footer">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('click', '.edit-att', function() {
              var id = $(this).data('id');
                // ajax
                $.ajax({
                    type: "POST",
                    ...
                    dataType: 'json',
                    success: function(res) {
                        $('#ajax-book-model-att').modal('show');
                        $('#img-atts').attr("src", res.end_work_info_url);
                    }
                });
            });
