                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">User - Edit</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                          <div class="card">
                            <div class="card-body">
                              <form action="{{ route('edits-user') }}" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                  ...
                                  <select class="form-control" name="role_app" id="">
                                    <option value="{{ $user->role_app }}"selected>{{ $user->role_app }}</option>
                                ...
                                <div class="mb-3">
                                  ...
                                  <input class="form-control" type="password" name="password" id="" placeholder="masukan kata sandi" value="{{ $user->password }}">
                                </div>

                                <div class="mb-0">
                                  <button class="btn btn-primary form-control">Ubah</button>
                                </div>
