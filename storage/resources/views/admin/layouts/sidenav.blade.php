    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main"
        ...
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->dept == 'HR Legal' || Auth::user()->dept == 'HR & Legal')
                {{-- <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('attendance-summary') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if (Auth::user()->role_app == 'Inputer' || Auth::user()->role_app == 'Admin')
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-per-emp') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-table-list"></i>
                        </div>
                        <span class="nav-link-text ms-1">Kehadiran Staff, Monthly & Manager</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-reg') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-table-list"></i>
                        </div>
                        <span class="nav-link-text ms-1">Kehadiran Regular</span>
                    </a>
                </li> --}}
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-per-dept') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-table-list"></i>
                        </div>
                        <span class="nav-link-text ms-1">Kehadiran Per Dept.</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-per-dept-reg') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-table-list"></i>
                        </div>
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-cuti') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-regular fa-table"></i>
                        </div>
                        <span class="nav-link-text ms-1">Summary Cuti</span>
                    </a>
                </li> --}}
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('summary-kategori') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-regular fa-table"></i>
                        </div>
            ...
            @if (Auth::user()->dept == 'HR Legal' || Auth::user()->dept == 'HR & Legal')
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('shift-dua') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="far fa-calendar-alt"></i>
                        </div>
                        <span class="nav-link-text ms-1">Data Shift</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('shift-new') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="far fa-calendar-alt"></i>
                        </div>
                        <span class="nav-link-text ms-1">Shift Detail</span>
                    </a>
                </li>
            @endif
